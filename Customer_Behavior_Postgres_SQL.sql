...
--2.Which customer used a discount but still spent more than the average spent amount?
...
select item_purchased,round(avg(review_rating::numeric),2) average_review_rating
from customer
...
select customer_segment,count(customer_segment) number_of_customers
from customer_type
